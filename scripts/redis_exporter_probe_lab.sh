...
echo "Watch omni-executor logs when confirming rollout: event=pre_apply_revalidate_ok"
echo "Or: kubectl logs -n $NS deploy/omni-executor --tail=200 | grep pre_apply_revalidate_ok"

// Line-level diff for Mermaid diagram texts (small inputs: a few dozen lines /
// version). Classic LCS backtrack — good enough at this size, no dependency
// needed. Ported from ui/lib/diagram-diff.ts (Productization Iteration 23).

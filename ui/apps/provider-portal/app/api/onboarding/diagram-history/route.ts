...
// Ported from ui/app/api/onboarding/diagram-history/route.ts (Productization
// Iteration 23) — this client panel needs an interactive fetch-on-click proxy,
// which lib/gateway.ts (server-component-only) does not provide.
